...
class BossViewContent extends Component {
  constructor() {
    super();
    this.state = {
      // dashboard: {},
    ...
    return (
      <div className="dashboard container">
        <Card className="cardo_botton">
          <CardBody style={{ padding: '0px 10px' }}>
            <div className="profile_casos card" style={{ flexWrap: 'wrap', justifyContent: 'flex-start' }}>
              <div className="compacted col-md-8">
            ...
            <div className="profile_casos card" style={{ flexWrap: 'wrap', justifyContent: 'flex-start' }}>
              <div className="profile_info col-md-12">
                ...
                <FormGroup className="details_profile_columned" style={{ margin: 0 }}>
                  <h2 className="title_modal_contact mb-2">Resumen</h2>
                  <div className="top_linear_divaindo">___</div>
                </FormGroup>
                <div className="profile_info_calls" style={{ flexWrap: 'wrap' }}>
                  <div className="profile_info" style={{ cursor: 'pointer', textAlign: 'center' }}>
                    ...
                    <h5> <strong>Gestiones realizadas</strong></h5>
                  </div>
                  <div className="profile_info" style={{ cursor: 'pointer', textAlign: 'center' }}>
                    <h1> <strong>{ (dashboard) ? (dashboard.todayWith) ? dashboard.todayWith : 0 : 0 }</strong> </h1>
                    <h5> <strong>N° Contactados</strong></h5>
                  </div>
                  <div className="profile_info" style={{ cursor: 'pointer', textAlign: 'center' }}>
                    <h1> <strong>{ (dashboard) ? (dashboard.todayOut) ? dashboard.todayOut : 0 : 0 }</strong> </h1>
                    <h5> <strong>Compromisos</strong></h5>
                  </div>
                  <div className="profile_info" style={{ cursor: 'pointer', textAlign: 'center' }}>
                    <h1> <strong>0</strong> </h1>
                    <h5> <strong>Compromisos rotos</strong></h5>
                  </div>
                  <div className="profile_info" style={{ cursor: 'pointer', textAlign: 'center' }}>
                    <h1> <strong>0</strong> </h1>
                    <h5> <strong>Sin compromisos</strong></h5>
                  </div>
                  <div className="profile_info" style={{ cursor: 'pointer', textAlign: 'center' }}>
                    <h1> <strong>0</strong> </h1>
                    <h5> <strong>Saldo asignación total</strong></h5>
                  </div>
                  <div className="profile_info" style={{ cursor: 'pointer', textAlign: 'center' }}>
                    <h1> <strong>0</strong> </h1>
                    <h5> <strong>Saldo asignación hoy</strong></h5>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="cardo_botton">
          <CardBody style={{ padding: '0px 10px' }}>
            <FormGroup className="details_profile_columned" style={{ margin: 0 }}>
              <h3 className="title_modal_contact mb-2" style={{ padding: '10px' }}>Ejecutivos</h3>
            </FormGroup>
            <ExecutiveList
...
export default connect(mapStateToProps, mapDispatchToProps, null, { forwardRef: true })(BossViewContent);
